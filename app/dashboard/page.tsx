...
export default function DashboardPage() {
  ...
  <StatCard label="Total Orders Weight" value={stats.totalOrdersWeight} suffix="kg" color="blue" />
  <StatCard label="Cut Weight" value={stats.totalInvoiceWeight} suffix="kg" color="red" />
  <StatCard label="Remaining Weight" value={stats.totalWeight} suffix="kg" color="green" />
